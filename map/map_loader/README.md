...
lanelet2_map_loader loads Lanelet2 file(s) and publishes the map data as autoware_auto_mapping_msgs/HADMapBin message.
...
Please see [tier4_autoware_msgs/msg/MapProjectorInfo.msg](https://github.com/tier4/tier4_autoware_msgs/blob/tier4/universe/tier4_map_msgs/msg/MapProjectorInfo.msg) for supported projector types. `lanelet2_map_loader`
provides Lanelet2 maps in two different configurations:

- It loads single Lanelet2 file and publishes the map data as `autoware_auto_mapping_msgs/HADMapBin` message.
...
A.osm:
  id: 1
  origin_lat: 41.026402
  origin_lon: 28.885332
B.osm:
  id: 2
  origin_lat: 41.027302
  origin_lon: 28.885357
c.osm:
  id: 3
  origin_lat: 41.028203
  origin_lon: 28.885383
```
...
- `id` is the unique identifier of the map.
- `origin_lat` and `origin_lon` are the latitude and longitude of the left bottom corner of the map (southwest corner).
...
- ~output/dynamic_lanelet2_map (autoware_auto_mapping_msgs/HADMapBin) : Binary data of loaded Lanelet2 Map
...
- ~service/get_differential_lanelet_map (autoware_map_msgs/srv/GetDifferentialLanelet2Map) : Differential loading of Lanelet2 Map
